...
export function Sidebar() {
  ...
  return (
    <>
      <aside className="hidden md:flex w-72 flex-col gap-5 border-r border-border/80 bg-[#f0ebe2]/70 px-4 py-5">
        <div className="rounded-[1.5rem] border border-border/70 bg-white/65 p-4 shadow-[0_12px_30px_rgba(31,37,32,0.05)]">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-white text-foreground shadow-[0_10px_22px_rgba(31,37,32,0.06)]'
        ...
        <div className="rounded-[1.5rem] border border-border/70 bg-white/65 p-4 shadow-[0_12px_30px_rgba(31,37,32,0.05)]">
          ...
          <Link
            href="/agents/new"
            className="flex min-h-11 items-center justify-center gap-2 rounded-full bg-primary px-4 text-sm font-semibold text-primary-foreground transition-[background-color,transform] duration-200 hover:bg-[#175645] hover:-translate-y-px"
          >
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 flex md:hidden items-center justify-around border-t border-border/80 bg-background/96 px-2 py-2 backdrop-blur-xl">
        ...
        <Link
          href="/agents/new"
          className="flex min-h-11 min-w-14 flex-col items-center justify-center gap-1 rounded-2xl px-3 py-2 text-[11px] font-medium text-muted-foreground transition-[background-color,color] duration-200 hover:bg-white hover:text-foreground"
        >
